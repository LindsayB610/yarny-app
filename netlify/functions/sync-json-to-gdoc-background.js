    ...
    try {
        ...
        try {
            ...
            if (!snippetId || !content || !gdocFileId || !parentFolderId) {
                return (0, types_1.createErrorResponse)(400, "snippetId, content, gdocFileId, and parentFolderId required");
            }
        }
        catch (parseError) {
            return (0, types_1.createErrorResponse)(400, "Invalid request body");
        }
        ...
        return (0, types_1.createErrorResponse)(500, error instanceof Error ? error.message : "Failed to sync JSON to Google Doc");
    }
};
