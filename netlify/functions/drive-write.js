    ...
    try {
        ...
        if (isGoogleDoc) {
            ...
            if (!credentials || !credentials.access_token) {
                ...
                try {
                    ...
                    throw new Error("Authentication client not properly initialized - failed to get access token: " +
        ...
        if (fileId) {
            ...
            if (!fileExists) {
                ...
                return (0, types_1.createErrorResponse)(404, "FILE_NOT_FOUND", "File was deleted or does not exist");
            }
                        ...
                        if (err.status === 401 || err.code === 401) {
                            ...
                            if (!hasDocsScope) {
                                ...
                                try {
                                    ...
                                    const store = (0, blobs_1.getStore)(storeOptions);
                                ...
                                return (0, types_1.createErrorResponse)(403, "MISSING_DOCS_SCOPE", "OAuth tokens are missing Google Docs API scope. Please re-authorize Drive access to enable Google Docs creation.");
                            }
                            else {
